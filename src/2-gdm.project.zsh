...
gdm.project() {
  ...
  local prev_project="Project" ; [[ "$1" =~ '^[-]{0,2}init$' ]] && prev_project="Previous project" # for output
...
gdm_locateProject() { 
  ...
  #          If a PROJ_CONFIG_FILE is found, gdm_locateProject validates it and returns an error if:
